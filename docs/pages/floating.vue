  ...
  <DocsPageTemplate>
    ...
    >
      ...
      <ul>
        ...
        <li>
          Removal of
          <code>vue-popper</code> and <code>Popper 1</code> from <code>KTooltip</code> in favor of
          the composables.
        </li>
        <li>
        ...
        <li>
          Only one third-party dependency is used, solely for low-level position calculations, in
          the above <code>K</code> components (<code>Popper 2</code>).
        </li>
      ...
      <p>
        See the TODO link for implementation details, performance considerations, browser support,
        and the choice of third-party library.
      </p>
    </DocsPageSection>
    ...
    >
      <ul>
        ...
        <li>Abstracts away the third-party positioning library (<code>Popper 2</code>).</li>
        <li>Can be used both within and outside of KDS.</li>
        <li>Is used by <code>KTooltip</code>.</li>
        <li>
    ...
    >
      <p>
        <code>vue-popper</code> and <code>Popper 1</code> have been removed from
        <code>KTooltip</code>, which is now built with <code>useKFloatingInteraction</code> and
        <code>useKFloatingPosition</code>. It provides the same features as before, plus a few new
        ones used in the examples below—such as lazy rendering, event delegation, configurable
        interactions, and the option to define an anchor different from the trigger element.
      </p>
      ...
      <p>
        ...
        performance optimizations (TODO link), eliminates the need for several extra props, and
        aligns with how <code>aria-labelledby</code> / <code>aria-describedby</code> reference IDs,
        allowing for reuse of the same ID.
      </p>
    ...
    >
      ...
      <p>
        ...
        <code>tippy.js</code> in KDS menu components. See <code>lib/KContextMenu.vue</code> (TODO
        link).
      </p>
    </DocsPageSection>
  </DocsPageTemplate>
