<template>
  ...
  <DocsPageTemplate apiDocs>
    ...
    <DocsPageSection title="Usage" anchor="#usage">
      <p>Polite and assertive regions are attached to an application's DOM <DocsInternalLink href="/installation#initialize-dom" text="during one of the steps of the KDS installation process" />. So, if you have installed KDS properly, the only thing you need to do to deliver messages is to import and call <code>sendPoliteMessage</code> or <code>sendAssertiveMessage</code> from any place in your application.</p>
