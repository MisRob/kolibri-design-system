<template>
  ...
  <DocsPageTemplate apiDocs>
    ...
    >
      ...
      <p>
        <code>initPosition</code> and <code>destroyPosition</code> are convenient shortcuts for the
        majority of use cases, but you can also use the underlying Floating UI functions directly
        for more control. Simply import Floating UI functions from
        <code>useKFloatingPosition</code> and use them as described in
        <DocsExternalLink
          href="https://floating-ui.com/docs/computePosition"
          text="Floating UI documentation"
        />. This is particularly useful in cases you only need to receive
        <code>x, y</code> coordinates and want to apply them to the element on your own.
      </p>
