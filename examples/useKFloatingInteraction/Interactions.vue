<template>
  ...
  <div>
    <KButton :data-floating-id="TOOLTIP_ID"> Touch or keyboard focus me </KButton>
...
<script>
  ...
  export default {
    setup() {
      ...
      const { isActive, activatorEl } = useKFloatingInteraction(TOOLTIP_ID, floatingRef, {
        activateOn: ['touch', 'keyboardfocus'],
      });
