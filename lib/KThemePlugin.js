...
import vFocusable from './directives/v-focusable.js';
...
import KContextMenu from './KContextMenu/index.vue';
...
export default function KThemePlugin(Vue) {
  ...
  Vue.directive('focusable', vFocusable);
  ...
  Vue.component('KContextMenu', KContextMenu);
