...
const KolibriIcons = {
  ...
  assignCoaches: {
    icon: require('./precompiled-icons/le/assignCoaches.vue').default,
    rtlFlip: true,
  },
  admins: {
    icon: require('./precompiled-icons/le/admins.vue').default,
  },
  superAdmins: {
    icon: require('./precompiled-icons/le/super_admins.vue').default,
  },
  learners: {
    icon: require('./precompiled-icons/le/learners.vue').default,
  },
  coaches: {
    icon: require('./precompiled-icons/le/coaches.vue').default,
  },
  allUsers: {
    icon: require('./precompiled-icons/le/all_users.vue').default,
  },
  dropdown: {
  ...
  expand: { icon: require('./precompiled-icons/le/expand.vue').default },
  ...
  help: {
    icon: require('./precompiled-icons/le/help.vue').default,
  },
  helpOutline: {
    icon: require('./precompiled-icons/material-icons/help_outline/outline.vue').default,
  },
  ...
  circleCheckmark: {
    icon: require('./precompiled-icons/le/circleCheckmark.vue').default,
    rtlFlip: true,
  },
  autoReplace: {
    icon: require('./precompiled-icons/le/autoReplace.vue').default,
    rtlFlip: true,
  },
  ...
  basicSkillsResource: {
    icon: require('./precompiled-icons/le/basicSkills.vue').default,
  },
  dailyLifeResource: {
    icon: require('./precompiled-icons/le/dailyLife.vue').default,
  },
  forTeachersResource: {
    icon: require('./precompiled-icons/le/forTeachers.vue').default,
  },
  schoolResource: {
    icon: require('./precompiled-icons/le/school.vue').default,
    rtlFlip: true,
  },

  //  more options / other category
  optionsCircle: {
    icon: require('./precompiled-icons/le/optionsCircle.vue').default,
  },
  ...
  // Documentation Icons
  github: {
    icon: require('./precompiled-icons/le/github.vue').default,
  },
};
