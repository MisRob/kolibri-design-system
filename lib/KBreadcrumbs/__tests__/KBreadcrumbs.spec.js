...
it('Breadcrumbs - Overflow with Dropdown Open (with links)', async () => {
  ...
  try {
    ...
    console.log('Dropdown button not found, component may not be overflowing');
  }

  await takeSnapshot('KBreadcrumbs - Overflow with Dropdown Open (with links)', narrowSnapshotOptions);
});
...
it('Breadcrumbs - Overflow with Dropdown Open (without links)', async () => {
  ...
  await takeSnapshot('KBreadcrumbs - Overflow with Dropdown Open (without links)', narrowSnapshotOptions);
});
});